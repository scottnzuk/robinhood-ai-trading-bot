...
echo "6. After VSCode restarts, open a new terminal and activate your virtual environment:"
echo "   source /Users/byteme/robinhood-ai-trading-bot/venv_new/bin/activate"

echo "7. Verify with:"
echo "   which python"

echo "=== VSCode Terminal Reset Script Complete ==="